let fun = function(instance, properties, context) {
    ...
    function createRequestButton(options){
        const {
            parentElement,
            cancel:renderCancel,
            deny:renderDeny,
            accept:renderAccept,
            acceptAndDeny:renderAcceptAndDeny,
            edit:renderEdit,
            resubmit:renderResubmit,
            submit:renderSubmit,
        ...
        if(renderDeny){
            const denyRequestButton = elementAssembler({
                elementType:"button",
                parent:parentElement,
                className: "deny-request-button",
                innerHTML:"Deny Request"
            });
            denyRequestButton.addEventListener('click',(e)=>{
                /*
            ...
            if(userRole==="Worker"){
                ...
                if(thisWorkerAmount){
                    ...
                    if(requestStatusDisplay==="Pending"&&requestedByDisplay==="Worker"){
                       ...
                       createRequestButton({
                            parentElement:requestContainer,
                            edit:true,
                            workerAmountID,
                            estimate,
                            workerAreaContainer,
                ...
                workerAmountsRequested.forEach(workerAmount=>{
                    ...
                    const requestedWorkerEstimate = elementAssembler({
                        parent:requestedWorkerFirstLine,
                        className: "requested-worker-estimate",
                        innerHTML:estimate
                    });
                    const requestedWorkerStatus = elementAssembler({
                        parent:requestedWorkerFirstLine,
                        className: "requested-worker-status",
                        innerHTML:requestStatusDisplay
                    });
                    ...
                    */
                   console.log({requestStatusDisplay,requestedByDisplay})
                    if(requestStatusDisplay==="Pending"){
                        if(requestedByDisplay==="Admin"){
                            createRequestButton({
                                parentElement:requestedWorkerSecondLine,
                                cancel:true,
                                workerAmountID,
                                estimate,
                                workerAreaContainer,
                        ...
                        }else if(requestedByDisplay==="Worker"){
                            console.log("hi!");
                            createRequestButton({
                                parentElement:requestedWorkerSecondLine,
                                deny:true,
